...
#ifdef _MSC_VER
static int windows_load_system_certificates(struct flb_tls *ctx)
{
    int ret;
...
static int load_system_certificates(struct flb_tls *ctx)
{
    int ret;
...
struct flb_tls_backend tls_mbedtls = {
    .name            = "mbedtls",
